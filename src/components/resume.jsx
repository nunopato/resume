        ...
        <Page>
          ...
          <Period>
            <Company>
              ...
              <Location>
                <svg style={ { height: '7mm', width: '7mm' } }>
          ...
          <Period>
            ...
            <Responsibilities>
              <Responsibility>Business development, marketing, sales, and public speaking training</Responsibility>
            </Responsibilities>
          </Period>
          ...
          <Period>
            ...
            <Responsibilities>
              ...
              <Responsibility>Built an additional engineering team (Media Intelligence), mentoring interns and promoting internally</Responsibility>
            ...
            <Responsibilities>
              ...
              <Responsibility>Built an additional engineering team (Media Platform API), recruiting both engineers and manager</Responsibility>
              <Responsibility>Increased service availability from 98% to 99.98%, by designing a distributed caching layer</Responsibility>
              <Responsibility>Architected and implemented video adaptive streaming delivery with MPEG-DASH and VP9</Responsibility>
          ...
          <Period>
            ...
            <Responsibilities>
              <Responsibility>API design, frontend and backend architecture and implementation with micro services</Responsibility>
